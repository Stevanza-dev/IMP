        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="relative border-l-4 border-blue-100 ml-4 md:ml-6 space-y-12">
                ...
                <div class="relative pl-8 md:pl-12 group">
                    ...
                    <div class="absolute -left-[10px] top-6 w-6 h-6 rounded-full border-4 border-white 
                        {{ $item->is_active ? 'bg-green-500 shadow-[0_0_0_4px_rgba(34,197,94,0.2)]' : 'bg-gray-400' }}">
                    </div>

                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 relative">
