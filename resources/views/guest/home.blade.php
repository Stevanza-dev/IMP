...
<body class="bg-gray-50 text-gray-800">
    ...
    <section class="hero-bg h-screen flex items-center justify-center text-center px-4 relative mt-16 md:mt-0">
        <div class="max-w-4xl mx-auto text-white z-10 animate-fade-in-up">
            ...
            <p class="text-lg md:text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
                Pindah berkala Rumah ke Rumah, mengambil pelajaran jika berpisah. Jikalau suatu saat berujung indah,
    ...
    <section class="relative -mt-16 md:-mt-20 z-20 px-4">
        <div
            class="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl p-8 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
    ...
    <section id="about" class="py-20 md:py-32 px-4">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative order-2 md:order-1">
                ...
                <img src="{{ asset('images/makrab.jpg') }}" alt="Kegiatan IMP"
            ...
            <div class="order-1 md:order-2">
                ...
                <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                    Ikatan Mahasiswa Pati Universitas Negeri Semarang (IMP UNNES) adalah organisasi daerah yang menaungi
                    mahasiswa asal Kabupaten Pati yang sedang menempuh studi di UNNES.
                </p>
                <p class="text-gray-600 text-lg mb-8 leading-relaxed">
                    Berdiri sejak 37 tahun lalu, kami berkomitmen untuk menciptakan rasa kekeluargaan yang erat
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Berbagai kegiatan positif yang kami rancang untuk pengembangan diri anggota dan kebermanfaatan bagi
                    masyarakat.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach($programs as $proker)
                    <div
                        class="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300 overflow-hidden group border border-gray-100 flex flex-col">
                        <div class="h-2 bg-blue-600 w-0 group-hover:w-full transition-all duration-500"></div>

                        <div class="p-8 flex-grow">
                            <div
                                class="w-14 h-14 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600 mb-6 text-2xl group-hover:scale-110 transition">
    ...
    <section class="py-20 px-4">
        <div
            class="max-w-5xl mx-auto bg-gradient-to-r from-blue-700 to-blue-900 rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
            <div
                class="absolute top-0 left-0 w-64 h-64 bg-white opacity-5 rounded-full -translate-x-1/2 -translate-y-1/2">
            </div>
            <div
                class="absolute bottom-0 right-0 w-64 h-64 bg-white opacity-5 rounded-full translate-x-1/2 translate-y-1/2">
            </div>
            ...
            <p class="text-blue-100 text-lg mb-8 max-w-2xl mx-auto relative z-10">
                Temukan rumah keduamu di Semarang. Mari bertumbuh, belajar, dan berkontribusi bersama Ikatan Mahasiswa
                Pati UNNES.
            </p>
            <div class="relative z-10">
                <a href="#"
                    class="bg-white text-blue-800 font-bold py-3 px-10 rounded-full hover:bg-gray-100 transition shadow-lg inline-block">
                    Coming Soon
                </a>
            </div>
        </div>
