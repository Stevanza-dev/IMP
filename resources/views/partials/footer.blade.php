        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6 max-w-sm">
                    Ikatan Mahasiswa Pati Universitas Negeri Semarang. Wadah persaudaraan, pengembangan diri, dan kontribusi nyata untuk daerah tercinta.
                </p>
                <p class="text-slate-400 text-sm font-semibold">
                    Sekretariat:
                </p>
                <p class="text-slate-500 text-sm">
                    Gedung PKM UNNES, Sekaran, Gunungpati, Semarang.
                </p>
            </div>
            ...
            <div>
                <h3 class="text-lg font-bold mb-4 text-white border-b-2 border-blue-500 inline-block pb-1">Ikuti Kami</h3>
                ...
                <div class="flex flex-col space-y-3">
                    @foreach($socials as $soc)
                        <a href="{{ $soc->url }}" target="_blank" class="flex items-center group">
                            <span class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-blue-400 group-hover:bg-blue-600 group-hover:text-white transition duration-300">
                                <i class="{{ $soc->icon_class }}"></i>
                            </span>
                            <span class="ml-3 text-sm text-slate-300 group-hover:text-white transition">{{ $soc->name }}</span>
                        </a>
                    @endforeach
                </div>
            </div>
