...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
    ...
    <div class="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="bg-blue-600 p-6 text-white text-center">
            ...
            <p class="text-sm opacity-80 mt-1">{{ \Carbon\Carbon::parse($meeting->date)->translatedFormat('l, d F Y') }}</p>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('attendance.store', $meeting->token) }}" method="POST" id="absenForm">
                ...
                <div class="mb-4">
                    ...
                    <select name="member_id" id="member_select" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-blue-500 outline-none" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="division_display" class="w-full bg-gray-100 border border-gray-300 rounded-lg p-3 text-gray-500 cursor-not-allowed" readonly placeholder="Otomatis terisi..." required>
                </div>

                <div class="mb-6 p-3 bg-blue-50 rounded-lg text-sm text-center border border-blue-200">
                    <p id="location-status" class="text-blue-800 font-semibold animate-pulse">📡 Mencari lokasi Anda...</p>
                </div>

                <input type="hidden" name="latitude" id="lat">
                <input type="hidden" name="longitude" id="lng">

                <button type="submit" id="btn-submit" disabled class="w-full bg-gray-400 text-white font-bold py-3 rounded-lg shadow transition duration-300 cursor-not-allowed">
                    KIRIM ABSENSI
                </button>
            </form>
            @endif
